...
<div class="container-fluid">
    ...
    <section class="content-header">
        <hr><h2 class="concss">
            <a href="<?= _SERVER_ ?>"><i class="fa fa-home"></i> INICIO</a> >
            <a href="<?= _SERVER_ ?>Inventario/productos"><i class="<?php echo $_SESSION['icono'];?>"></i> <?php echo $_SESSION['controlador'];?></a> >
    ...
    <section class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header fondo text-primary">
                        <div style="display: flex;justify-content: space-between">
                            <h6>PRODUCTOS REGISTRADOS</h6>
                            <a class="btn btn-success btn-sm font-weight-bold" href="<?php echo _SERVER_;?>Inventario/agregar_producto" ><i class="fa fa-plus"></i> AGREGAR NUEVO PRODUCTO</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <table class="table table-bordered" id="dataTable2" width="100%" cellspacing="0">
                            ...
                            foreach ($productos as $p){
                                ...
                                <tr id="producto<?= $p->id_producto;?>">
                                    ...
                                    <td>
                                        <a style="color: blue; cursor: pointer;" class="button" data-toggle="modal" data-target="#" onclick="llenar_modal(<?= $p->id_producto;?>)">
                                    ...
                                    <td><a class="btn btn-chico btn-warning" type="button" href="<?php echo _SERVER_;?>Inventario/editar_producto/<?php echo $p->id_producto;?>"><i class="fa fa-pencil"></i> Editar</a>
                                        ...
                                        if($resultado){
                                            ?>
                                            <button id="btn-eliminar_producto<?= $p->id_producto;?>" class="btn btn-chico btn-danger btn-xs" onclick="preguntar('¿Está seguro que desea eliminar este producto?','eliminarproducto','Si','No',<?= $p->id_producto;?>)"><i class="fa fa-times"></i> Eliminar</button>
                                            <?php
                                        }else{
                                            ?>
