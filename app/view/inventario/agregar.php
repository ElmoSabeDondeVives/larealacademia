...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            <h5 class="font-weight-bold" style="text-align: center">CONCEPTO A AGREGAR</h5>
        </div>
    </div>
    <br>
    ...
    <div class="row">
        <div class="col-md-12">
            <input type="hidden" id="id_proveedor" value="1">
...
/*                }
        ...
        <div class="col-md-4 d-none">
            ...
            <input type="hidden" value="59" id="id_medida">
...
/*                }
        ...
        <div class="col-md-4 d-none">
            ...
            <input type="hidden" value="20" id="id_tipoafectacion">
...
/*                }
    ...
    <div class="row">
        <div class="col-md-3 d-none">
            ...
            <input type="text" class="form-control" id="producto_stock" value="2000000" placeholder="Ingresar Stock Producto..." onkeypress="return validar_numeros(this.id)">
        </div>
        <div class="col-md-3 d-none">
            <label >Precio Por Unidad Compra</label>
            <input type="text" value="0" class="form-control" id="producto_precio_compra" placeholder="Ingresar Precio Compra de Producto..." onkeypress="return validar_numeros_decimales_dos(this.id)">
        </div>
        <div class="col-md-6">
            <label >Precio Por Unidad Venta</label>
            <input type="text" class="form-control" id="producto_precio_valor" placeholder="Ingresar Precio Venta Producto..." onkeypress="return validar_numeros_decimales_dos(this.id)" onkeyup="valor_precio(this.id)">
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <button id="btn-agregar_producto" type="submit" class="btn btn-primary" style="margin-top:33px; width:100%" onclick="add()"><i class="fa fa-save fa-sm text-white-50"></i> GUARDAR CONCEPTO</button>
        </div>
        <div class="col-md-4"></div>
    </div>
</div>
...
<script>
    function valor_precio(id){
        let precio = $('#'+id).val();
        $('#producto_precio_valor_xmayor').val(precio);
