        ...
        <div class="wrap-login100 p-t-190 p-b-30">
            <div class="login100-form validate-form">
                <div class="login100-form-avatar">
                    <img src="<?=_SERVER_ . _STYLES_LOGIN_;?>images/logo_real.png" alt="Logo de Proyecto">
                </div>

                <span class="login100-form-title p-t-10 p-b-45" style="color: white">LA REAL ACADEMIA</span>
