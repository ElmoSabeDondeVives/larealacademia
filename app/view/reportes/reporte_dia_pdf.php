...
$pdf->Cell(110,6,'CONCEPTO',1,0,'L',1);
/*$pdf->Cell(20,6,'Inv. Inicial',1,0,'C',1);*/
/*$pdf->Cell(20,6,'Agregado',1,0,'C',1);*/
$pdf->CellFitSpace(30,6,'Precio Unitario',1,0,'C',1);
$pdf->CellFitSpace(25,6,'Cant.',1,0,'C',1);
...
foreach ($productos as $p){
    ...
    if($sumasa > 0) {
        $pdf->CellFitSpace(110, 6, $p->producto_nombre, 1, 0, 'L', 0);
        /*$pdf->CellFitSpace(20, 6, $nuevo_valor_inicial ?? 0, 1, 0, 'C', 0);*/
        /*$pdf->CellFitSpace(20, 6, $stock_added ?? 0, 1, 0, 'C', 0);*/
        $pdf->CellFitSpace(30, 6, $p->producto_precio_valor, 1, 0, 'C', 0);
        $pdf->CellFitSpace(25, 6, $cantidad ?? 0, 1, 0, 'C', 0);
        /*$pdf->CellFitSpace(20, 6, $stock_out ?? 0, 1, 0, 'C', 0);*/
        /*$pdf->CellFitSpace(30, 6, $stock_now ?? 0, 1, 0, 'C', 0);*/
        $pdf->CellFitSpace(25, 6, 'S/. ' . $total_por_producto ?? 0, 1, 1, 'C', 0);
