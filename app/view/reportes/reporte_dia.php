...
<div class="container-fluid">
    ...
    <section class="content" style="background-color: white;box-shadow: 2px 2px 2px #888888;border-radius: 5px; padding: 10px; margin: 10px; min-height: 500px">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h4 style="text-align: center;">REPORTE GENERAL > <i class="fa fa-calendar"></i> Desde: <?php echo $fecha_filtro;?> Hasta: <?php echo $fecha_filtro_fin;?></h4>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <table class="table table-bordered table-hover" style="border-color: black">
                    ...
                    foreach ($productos as $p){
                        ...
                        $total_por_producto = $this->reporte->total_por_producto_toda_fila($fecha_filtro,$fecha_filtro_fin,$p->id_producto);
                    ...
                    ?>
                    <tr><td colspan="5" style="text-align: right">Total Ingresos Ventas Productos:</td><td style="background-color: #f9f17f"><b> S/. <?php echo number_format($ingresos_productos,2) ?? 0;?></b></td></tr>
                    </tbody>
                </table>
            </div>
        </div><br><br>
        ...
        <div class="row">
            <div class="col-lg-6">
                <h3 style="text-align: center">Egresos Del Turno</h3>
                <?php
                ...
                <table class="table table-bordered table-hover" style="border-color: black">
                    ...
                    <tr><td style="text-align: right;">Egresos Totales:</td><td style="background-color: #f9f17f"><b>S/. <?php echo number_format($egresos,2) ?? 0;?></b></td></tr>
                    </tbody>
                </table>
            </div>
            <?php
            ...
            <div class="col-lg-6"><br><br>
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td>S/. <?php echo number_format($ingresos_productos,2) ?? 0;?></td>
                    </tr>
                    <tr>
