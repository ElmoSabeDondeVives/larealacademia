...
$pdf->Cell(190,4,"$aula_c->evaluacion_concepto",0,1,'C');
$pdf->Cell(190,6," $fecha ",0,1,'C');
$pdf->Ln(3);
$pdf->SetFont('Helvetica','B',7);
$pdf->Cell(10, 6, '#', 1,'','C',0);
$pdf->Cell(100, 6, 'NOMBRE Y APELLIDOS',1,0,'L',0);
$pdf->Cell(60, 6, 'CARRERA', 1,'','L',0);
$pdf->Cell(20, 6, 'PUNTAJE',1,1,'L',0);

$pdf->SetWidths(array(10,100,60,20));
//PRODUCTOS
$aa=1;
$pdf->SetFont('Helvetica','',7);
foreach ($detalles as $d){
    $pdf->Row_L(array($aa, $d->cliente_nombre ,$d->carrera_descripcion,$d->nota_valor),0);
