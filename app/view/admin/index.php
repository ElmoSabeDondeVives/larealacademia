        ...
        <li>
            <div class="container_">
                <button class="cta">
                    ...
                    <a href="<?= _SERVER_. 'ventas/realizar_venta'?>" style="text-decoration: none" class="text-white"><span  class="button-text">Realizar Venta</span></a>
        ...
        <li>
            <div class="container_">
                <button class="cta">
                    ...
                    <a href="<?= _SERVER_. 'inventario/listarproductos'?>" style="text-decoration: none" class="text-white"><span  class="button-text">Conceptos</span></a>
                </button>
            </div>
        </li>
        <li>
            <div class="container_">
                <button class="cta">
                    ...
                    <a href="<?= _SERVER_. 'Clientes/listar'?>" style="text-decoration: none" class="text-white"><span  class="button-text ml-4">Alumnos</span></a>
                </button>
            </div>
        </li>
    </ul>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div style="background-image: url(<?= _SERVER_.'media/logo/1.jpg'?>)">
                    <div class="card-body text-center font-weight-bold text-white" style="background: #E87B14">
                        <h5><b>Bienvenido a LA REAL ACADEMIA</b></h5>
                    </div>
                </div>
    ...
    <div class="row">
        <!--<div class="col-lg-12 mb-3">
            <div class="card shadow mb-4">
                <div class="card-header fondo text-white py-3 text-center" >
                    <h6 class="m-0 font-weight-bold " style="text-transform: uppercase">Bienvenido a Ladrillera Eco-Morote</h6>
                </div>
                <div class="card-body" style="text-align: center;">
                    <h2 style="padding-top: 20px;color:rgb(24,35,51)" class="">Su Rol de Usuario es: <?php /*echo $this->encriptar->desencriptar($_SESSION['rn'],_FULL_KEY_);*/?></h2><br>
                </div>
            </div>
        </div>-->
                ...
                <?php if(!$fecha_open){ ?>
                    ...
                    <div class="row">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-4" style="background: url(<?= _SERVER_._ICON_?>) no-repeat;background-size: contain; display: flex; align-items: center">
...
-->                                    </div>
                                    <div class="col-lg-8 p-2" style="text-align: center;">
                                        <h3 class="texto-f mb-3" >El Monto de Apertura de Caja para hoy es: S/. <?php echo $monto_apertura;?></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<style>
    ...
    .lds-dual-ring:after {
        ...
        margin: 8px;
        border-radius: 50%;
        border: 6px solid rgba(24,35,51,0);
        border-color: rgba(24,35,51,0) transparent rgb(24,35,51) transparent;
