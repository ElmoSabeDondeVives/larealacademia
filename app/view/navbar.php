...
<div id="wrapper">
    ...
    <!-- Sidebar -->
    <ul class="navbar-nav sidebar sidebar-dark accordion toggled" id="accordionSidebar" style="background: rgb(54,54,61);">
        <!-- Sidebar - Brand -->
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= _SERVER_;?>" style="background: rgb(244,124,60)">
            <div class="sidebar-brand-icon ">
                <img src="<?= _SERVER_._ICON_;?>" style="width: 125px;" alt="Logo" />
            </div>
            <div class="sidebar-brand-text mx-3">Academia La Real</div>
        </a>
        <!-- Divider -->
        ...
        foreach ($navs as $nav){
            ...
            <li class="nav-item">
                <a class="<?= $nav_link;?>" href="#" data-toggle="collapse" data-target="#collapseMenu<?= $raioz;?>" aria-expanded="<?= $aria_expanded;?>" aria-controls="collapseMenu<?= $raioz;?>">
                    ...
                    <span class="text-uppercase"><?= $nav->menu_nombre;?></span>
                </a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            <!-- Topbar -->
            <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background: rgb(244,124,60)">
                ...
                <ul class="navbar-nav ml-auto">
                    <div class="d-lg-flex text-white font-weight-bold">Centro Pre Universitario La Real</div>
                    <div class="topbar-divider d-none d-sm-block"></div>
                    <!-- Nav Item - User Information -->

                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="mr-2 d-none d-lg-inline text-white small"><?= $this->encriptar->desencriptar($_SESSION['p_n'],_FULL_KEY_);?></span>
