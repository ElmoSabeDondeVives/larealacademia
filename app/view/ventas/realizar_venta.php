                    ...
                    <table id="dataTable2" class="table table-bordered table-hover">
                        ...
                        foreach ($productos as $p){
                            ...
                            <tr>
                                ...
                                <!--<td></td>-->
                                <input type="hidden" class="form-control" onkeyup="calcular_descuento_producto_<?php echo $p->id_producto_precio;?>(this.value)" style="width: 70px;" id="product_descuento<?php echo $p->id_producto_precio;?>" onkeypress="return valida(event)" value="">
    ...
    <section class="content" style="background-color: #ffffff; box-shadow: 5px 5px 5px #888888;border-radius: 15px; padding: 15px; margin: 50px; min-height: 500px">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <input style="width: 85%;" type="text" class="form-control" id="pago_cliente" onkeyup="calcular_vuelto(this.value); return validar_numeros(this.id)" >
            </div>
            ...
            <div class="col-lg-6">
                ...
                <select name="id_clase" id="id_clase" class="form-control">
                    ...
                    <?php foreach ($lista_clases as $cl){  ?>
                        <option value="<?= $cl->id ?>"><?= $cl->descripcion .' | '.$cl->ingreso. ' a ' .$cl->salida ?></option>
                    <?php } ?>
                </select>
            </div>
        </div><hr>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <button type="button" id="btn_generarventa" class="btn btn-primary" style="width: 100%; padding: 1.2rem; font-size: 1.5rem; width: 100%" onclick="preguntar('¿Está seguro que desea realizar esta Venta?','realizar_venta','Si','No')">
