...
*/
try{
    $logo = EscposImage::load("media/logo/logo_real_ticket.png", false);
...
$printer->setTextSize(1,1);
$printer->text("------------------------------------------------" . "\n");
$printer->text("DATOS DEL ALUMNO" . "\n");
//$printer->text("------------------------------------------------" . "\n");
/*Alinear a la izquierda*/
$printer->setJustification(Printer::JUSTIFY_LEFT);
$printer->text("NOMBRE: $cliente_nombre" . "\n");
...
$printer->setFont(Printer::FONT_B);
$printer->setTextSize(1,1);
$printer->text("Bufeo Tec Company Digitalízate" . "\n");
